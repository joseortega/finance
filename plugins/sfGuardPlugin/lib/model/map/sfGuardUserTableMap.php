...
class sfGuardUserTableMap extends TableMap {
	...
	{
    $this->addRelation('Transfer', 'Transfer', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Transaction', 'Transaction', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'RESTRICT', 'RESTRICT');
