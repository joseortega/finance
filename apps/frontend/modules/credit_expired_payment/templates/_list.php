<div class="list">
  ...
  <?php else: ?>
    <div class="title_actions_bar">
      ...
      <ul class="actions">
        <li><a class="minibutton" href="<?php echo url_for('credit_payment/payExpiredAll')?>"><span><?php echo __('Pay all')?></span></a></li>
      </ul>
    </div>
    <div class="rule"></div>
      ...
      <div class="credit_expired">
        <div class="credit title_actions_bar">
          ...
          <ul class="actions">
            ...
            <li><a class="gobutton" href="<?php echo url_for('credit_payment/payExpiredOneCredit?id='.$credit->getId())?>"><span><?php echo __('Pay')?></span></a></li>
          </ul>
        </div>
        <div class="list">
