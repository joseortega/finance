<ul class="sidetabs">
  ...
  <?php if($credit->isInRequest()):?>
    <li><a <?php if($sf_context->getModuleName()=='credit_committee_member') echo 'class="selected"';?> href="<?php echo url_for('credit_committee_member', $credit) ?>"><?php echo __('Credit Committee')?></a></li>
  <?php endif;?>
</ul>