...
<?php else: ?>
  ...
  <div class="alert <?php echo $transaction->getTypeOperationText()?>">
    <div class="body">
      <div class="title">
        ...
        <a class="ajax_link" href="<?php echo url_for('account_transaction_history/show?id='.$account->getId().'&transaction_id='.$transaction->getId())?>"><?php echo $transaction->getTransactionType()?></a>
  ...
  <?php if ($pager->haveToPaginate()): ?>
    <?php include_partial('account_transaction_history/pagination', array('pager' => $pager, 'account'=>$account)) ?>
  <?php endif; ?>
