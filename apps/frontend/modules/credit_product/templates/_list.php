<div class="list">
  ...
  <?php else: ?>
      ...
      <tr>
        <th colspan="4">
          <?php if ($pager->haveToPaginate()): ?>
            <?php include_partial('credit_product/pagination', array('pager' => $pager)) ?>
          <?php endif; ?>
    ...
    <tbody>
      ...
      <tr class="row">
        <td class="title"><a href="<?php echo url_for('credit_product_show', $product)?>"><?php echo $product->getName() ?></a></td>   
        <td class="count_accounts">
          <?php echo __('Investments')?>
          <?php echo $product->countCredits()?>
        </td>
      </tr>
      <?php endforeach; ?>
    </tbody>
