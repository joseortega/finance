...
<?php if ($sf_user->hasFlash('notice')): ?>
  <div class="notice">
    <a href="<?php echo url_for('associate_person_edit', $associate)?>"><?php echo __('Edit other options')?></a>
...
<div class="columns infocols clear_fix">
  <div class="first">
    <?php echo include_partial('associate_person/detail', array('associate'=>$associate))?>
  </div>
  <div class="last">
