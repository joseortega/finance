<div class="nav">
  <ul>
    ...
    <li><a <?php if($sf_context->getModuleName()=='credit_expired_payment') echo 'class="selected"';?> href="<?php echo url_for('@credit_expired_payment')?>"><?php echo __('Expired Payments') ?></a></li>
