...
<div class="htabs credit_product clear_fix">
  ...
  <div class="main">
    <div class="change_interest_rate clear_fix">
      ...
      <ul class="actions">
        <li><a class="minibutton" href="<?php echo url_for('account_product_interest_rate_edit', $product) ?>"><span><?php echo __('Change')?></span></a></li>
      </ul>
    </div>
    <div class="rule"></div>
    <?php include_partial('util/flashes') ?> 
    <?php include_partial('account_product_interest_rate/list', array('pager'=>$pager, 'product'=>$product))?>
  </div>
</div>