...
abstract class BaseCreditForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'issued_at'               => new sfWidgetFormDateTime(),
      'disbursed_at'            => new sfWidgetFormDateTime(),
      'annulled_at'             => new sfWidgetFormDateTime(),
    ...
    $this->setValidators(array(
      ...
      'issued_at'               => new sfValidatorDateTime(array('required' => false)),
      'disbursed_at'            => new sfValidatorDateTime(array('required' => false)),
      'annulled_at'             => new sfValidatorDateTime(array('required' => false)),
