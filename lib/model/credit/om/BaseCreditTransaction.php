...
/**
 * Base class that represents a row from the 'credit_transaction' table.
 *
 * 
 *
 ...
 */
abstract class BaseCreditTransaction extends BaseObject  implements Persistent {
	...
	const PEER = 'CreditTransactionPeer';
	 ...
	 * @return     CreditTransaction The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CreditTransactionPeer::ID;
		}
	...
	public function setCreditId($v)
	{
		...
		if ($this->credit_id !== $v) {
			$this->credit_id = $v;
			$this->modifiedColumns[] = CreditTransactionPeer::CREDIT_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = CreditTransactionPeer::NUM_COLUMNS - CreditTransactionPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating CreditTransaction object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CreditTransactionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseCreditTransaction:delete:pre') as $callable)
			{
			...
			if ($ret) {
				CreditTransactionPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseCreditTransaction:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseCreditTransaction:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseCreditTransaction:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				CreditTransactionPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CreditTransactionPeer::doInsert($this, $con);
					...
					$affectedRows += CreditTransactionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CreditTransactionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CreditTransactionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CreditTransactionPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CreditTransactionPeer::ID)) $criteria->add(CreditTransactionPeer::ID, $this->id);
		if ($this->isColumnModified(CreditTransactionPeer::CREDIT_ID)) $criteria->add(CreditTransactionPeer::CREDIT_ID, $this->credit_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CreditTransactionPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CreditTransaction (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CreditTransaction Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CreditTransactionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CreditTransactionPeer();
		}
		return self::$peer;
	}
	...
	public function getTransaction(PropelPDO $con = null)
	{
		if ($this->aTransaction === null && (($this->id !== "" && $this->id !== null))) {
			...
			$this->aTransaction->setCreditTransaction($this);
		}
	...
	public function getCredit(PropelPDO $con = null)
	{
		if ($this->aCredit === null && (($this->credit_id !== "" && $this->credit_id !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCredit->addCreditTransactions($this);
			 */
		}
		return $this->aCredit;
	}
	 ...
	 * Otherwise if this CreditTransaction has previously been saved, it will retrieve
	 * related Payments from storage. If this CreditTransaction is new, it will return
	 ...
	 * Otherwise if this CreditTransaction is new, it will return
	 * an empty collection; or if this CreditTransaction has previously
	 * been saved, it will retrieve related Payments from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in CreditTransaction.
	 */
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseCreditTransaction:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseCreditTransaction::%s', $method));
	  }
