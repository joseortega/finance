...
class PaymentTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('TRANSACTION_ID', 'TransactionId', 'BIGINT', 'credit_transaction', 'ID', false, null, null);
    ...
    $this->addRelation('Transaction', 'CreditTransaction', RelationMap::MANY_TO_ONE, array('transaction_id' => 'id', ), 'CASCADE', 'RESTRICT');
	} // buildRelations()
