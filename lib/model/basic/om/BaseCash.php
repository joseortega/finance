...
/**
 * Base class that represents a row from the 'cash' table.
 *
 * 
 *
 ...
 */
abstract class BaseCash extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseCash object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Cash The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CashPeer::ID;
		}
	...
	public function setAgencyId($v)
	{
		...
		if ($this->agency_id !== $v) {
			$this->agency_id = $v;
			$this->modifiedColumns[] = CashPeer::AGENCY_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = CashPeer::NAME;
		}
	...
	public function setIpAddress($v)
	{
		...
		if ($this->ip_address !== $v) {
			$this->ip_address = $v;
			$this->modifiedColumns[] = CashPeer::IP_ADDRESS;
		}
	...
	public function setBalance($v)
	{
		...
		if ($this->balance !== $v || $this->isNew()) {
			$this->balance = $v;
			$this->modifiedColumns[] = CashPeer::BALANCE;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v || $this->isNew()) {
			$this->status = $v;
			$this->modifiedColumns[] = CashPeer::STATUS;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = CashPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = CashPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->agency_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 8; // 8 = CashPeer::NUM_COLUMNS - CashPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Cash object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CashPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseCash:delete:pre') as $callable)
			{
			...
			if ($ret) {
				CashPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseCash:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseCash:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(CashPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(CashPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseCash:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				CashPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += CashPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CashPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CashPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CashPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CashPeer::ID)) $criteria->add(CashPeer::ID, $this->id);
		if ($this->isColumnModified(CashPeer::AGENCY_ID)) $criteria->add(CashPeer::AGENCY_ID, $this->agency_id);
		if ($this->isColumnModified(CashPeer::NAME)) $criteria->add(CashPeer::NAME, $this->name);
		if ($this->isColumnModified(CashPeer::IP_ADDRESS)) $criteria->add(CashPeer::IP_ADDRESS, $this->ip_address);
		if ($this->isColumnModified(CashPeer::BALANCE)) $criteria->add(CashPeer::BALANCE, $this->balance);
		if ($this->isColumnModified(CashPeer::STATUS)) $criteria->add(CashPeer::STATUS, $this->status);
		if ($this->isColumnModified(CashPeer::CREATED_AT)) $criteria->add(CashPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(CashPeer::UPDATED_AT)) $criteria->add(CashPeer::UPDATED_AT, $this->updated_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CashPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Cash (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Cash Clone of current object.
	 * @throws     PropelException
	 */
	...
	{
		if ($this->aAgency === null && (($this->agency_id !== "" && $this->agency_id !== null))) {
			$this->aAgency = AgencyPeer::retrieveByPk($this->agency_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aAgency->addCashs($this);
			 */
		}
		return $this->aAgency;
	}
	 ...
	 * Otherwise if this Cash has previously been saved, it will retrieve
	 * related Transactions from storage. If this Cash is new, it will return
		...
		if ($this->collTransactions === null) {
			if ($this->isNew()) {
			   $this->collTransactions = array();
				...
				$criteria->add(TransactionPeer::CASH_ID, $this->id);
	 ...
	 * Otherwise if this Cash is new, it will return
	 * an empty collection; or if this Cash has previously
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseCash:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseCash::%s', $method));
	  }
