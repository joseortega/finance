...
class AccountTableMap extends TableMap {
    ...
    $this->addRelation('TransferRelatedByAccountOriginId', 'Transfer', RelationMap::ONE_TO_MANY, array('id' => 'account_origin_id', ), 'CASCADE', 'RESTRICT');
    $this->addRelation('TransferRelatedByAccountDestinationId', 'Transfer', RelationMap::ONE_TO_MANY, array('id' => 'account_destination_id', ), 'CASCADE', 'RESTRICT');
    ...
    $this->addRelation('Transaction', 'Transaction', RelationMap::ONE_TO_MANY, array('id' => 'account_id', ), 'CASCADE', 'RESTRICT');
