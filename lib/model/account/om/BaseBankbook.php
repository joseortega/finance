...
abstract class BaseBankbook extends BaseObject  implements Persistent {
	...
	public function setPrintRow($v)
	{
		...
		if ($this->print_row !== $v || $this->isNew()) {
			$this->print_row = $v;
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->print_row = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setPrintRow($arr[$keys[4]]);
	 ...
	 * related Transactions from storage. If this Bankbook is new, it will return
		...
		if ($this->collTransactions === null) {
			if ($this->isNew()) {
			   $this->collTransactions = array();
				...
				$criteria->add(TransactionPeer::BANKBOOK_ID, $this->id);
