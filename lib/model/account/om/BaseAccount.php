...
abstract class BaseAccount extends BaseObject  implements Persistent {
	 ...
	 */
	protected $collTransfersRelatedByAccountOriginId;

	/**
	 * @var        Criteria The criteria used to select the current contents of collTransfersRelatedByAccountOriginId.
	 */
	private $lastTransferRelatedByAccountOriginIdCriteria = null;

	/**
	 * @var        array Transfer[] Collection to store aggregation of Transfer objects.
	 */
	protected $collTransfersRelatedByAccountDestinationId;

	/**
	 * @var        Criteria The criteria used to select the current contents of collTransfersRelatedByAccountDestinationId.
	 */
	private $lastTransferRelatedByAccountDestinationIdCriteria = null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->aAssociate = null;
			$this->aProduct = null;
			$this->collTransfersRelatedByAccountOriginId = null;
			$this->lastTransferRelatedByAccountOriginIdCriteria = null;

			$this->collTransfersRelatedByAccountDestinationId = null;
			$this->lastTransferRelatedByAccountDestinationIdCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collTransfersRelatedByAccountOriginId !== null) {
				foreach ($this->collTransfersRelatedByAccountOriginId as $referrerFK) {
			...
			if ($this->collTransfersRelatedByAccountDestinationId !== null) {
				foreach ($this->collTransfersRelatedByAccountDestinationId as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getTransfersRelatedByAccountOriginId() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addTransferRelatedByAccountOriginId($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getTransfersRelatedByAccountDestinationId() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addTransferRelatedByAccountDestinationId($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collTransfersRelatedByAccountOriginId collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addTransfersRelatedByAccountOriginId()
	 */
	public function clearTransfersRelatedByAccountOriginId()
	{
		$this->collTransfersRelatedByAccountOriginId = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTransfersRelatedByAccountOriginId collection (array).
	 *
	 * By default this just sets the collTransfersRelatedByAccountOriginId collection to an empty array (like clearcollTransfersRelatedByAccountOriginId());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initTransfersRelatedByAccountOriginId()
	{
		$this->collTransfersRelatedByAccountOriginId = array();
	}
	 ...
	 * related TransfersRelatedByAccountOriginId from storage. If this Account is new, it will return
	 ...
	 * @throws     PropelException
	 */
	public function getTransfersRelatedByAccountOriginId($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AccountPeer::DATABASE_NAME);
		}
		...
		if ($this->collTransfersRelatedByAccountOriginId === null) {
			if ($this->isNew()) {
			   $this->collTransfersRelatedByAccountOriginId = array();
				...
				$criteria->add(TransferPeer::ACCOUNT_ORIGIN_ID, $this->id);

				TransferPeer::addSelectColumns($criteria);
				$this->collTransfersRelatedByAccountOriginId = TransferPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				TransferPeer::addSelectColumns($criteria);
				if (!isset($this->lastTransferRelatedByAccountOriginIdCriteria) || !$this->lastTransferRelatedByAccountOriginIdCriteria->equals($criteria)) {
					$this->collTransfersRelatedByAccountOriginId = TransferPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastTransferRelatedByAccountOriginIdCriteria = $criteria;
		return $this->collTransfersRelatedByAccountOriginId;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countTransfersRelatedByAccountOriginId(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AccountPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collTransfersRelatedByAccountOriginId === null) {
			if ($this->isNew()) {
				...
				$count = TransferPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastTransferRelatedByAccountOriginIdCriteria) || !$this->lastTransferRelatedByAccountOriginIdCriteria->equals($criteria)) {
					...
					$count = count($this->collTransfersRelatedByAccountOriginId);
				}
			} else {
				$count = count($this->collTransfersRelatedByAccountOriginId);
			}
	 ...
	 * @throws     PropelException
	 */
	public function addTransferRelatedByAccountOriginId(Transfer $l)
	{
		if ($this->collTransfersRelatedByAccountOriginId === null) {
			$this->initTransfersRelatedByAccountOriginId();
		}
		if (!in_array($l, $this->collTransfersRelatedByAccountOriginId, true)) { // only add it if the **same** object is not already associated
			array_push($this->collTransfersRelatedByAccountOriginId, $l);
			$l->setAccountOrigin($this);
		}
	}
	 ...
	 * been saved, it will retrieve related TransfersRelatedByAccountOriginId from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Account.
	 */
	public function getTransfersRelatedByAccountOriginIdJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AccountPeer::DATABASE_NAME);
		}
		...
		if ($this->collTransfersRelatedByAccountOriginId === null) {
			if ($this->isNew()) {
				...
				$this->collTransfersRelatedByAccountOriginId = TransferPeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collTransfersRelatedByAccountDestinationId collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addTransfersRelatedByAccountDestinationId()
	 */
	public function clearTransfersRelatedByAccountDestinationId()
	{
		$this->collTransfersRelatedByAccountDestinationId = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTransfersRelatedByAccountDestinationId collection (array).
	 *
	 * By default this just sets the collTransfersRelatedByAccountDestinationId collection to an empty array (like clearcollTransfersRelatedByAccountDestinationId());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initTransfersRelatedByAccountDestinationId()
	{
		$this->collTransfersRelatedByAccountDestinationId = array();
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Account has previously been saved, it will retrieve
	 * related TransfersRelatedByAccountDestinationId from storage. If this Account is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getTransfersRelatedByAccountDestinationId($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AccountPeer::DATABASE_NAME);
		}
		...
		if ($this->collTransfersRelatedByAccountDestinationId === null) {
			if ($this->isNew()) {
			   $this->collTransfersRelatedByAccountDestinationId = array();
				...
				$criteria->add(TransferPeer::ACCOUNT_DESTINATION_ID, $this->id);

				TransferPeer::addSelectColumns($criteria);
				$this->collTransfersRelatedByAccountDestinationId = TransferPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				TransferPeer::addSelectColumns($criteria);
				if (!isset($this->lastTransferRelatedByAccountDestinationIdCriteria) || !$this->lastTransferRelatedByAccountDestinationIdCriteria->equals($criteria)) {
					$this->collTransfersRelatedByAccountDestinationId = TransferPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastTransferRelatedByAccountDestinationIdCriteria = $criteria;
		return $this->collTransfersRelatedByAccountDestinationId;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countTransfersRelatedByAccountDestinationId(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AccountPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collTransfersRelatedByAccountDestinationId === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastTransferRelatedByAccountDestinationIdCriteria) || !$this->lastTransferRelatedByAccountDestinationIdCriteria->equals($criteria)) {
					...
					$count = count($this->collTransfersRelatedByAccountDestinationId);
				}
			} else {
				$count = count($this->collTransfersRelatedByAccountDestinationId);
			}
	 ...
	 * @throws     PropelException
	 */
	public function addTransferRelatedByAccountDestinationId(Transfer $l)
	{
		if ($this->collTransfersRelatedByAccountDestinationId === null) {
			$this->initTransfersRelatedByAccountDestinationId();
		}
		if (!in_array($l, $this->collTransfersRelatedByAccountDestinationId, true)) { // only add it if the **same** object is not already associated
			array_push($this->collTransfersRelatedByAccountDestinationId, $l);
			$l->setAccountDestination($this);
		}
	}
	 ...
	 * Otherwise if this Account is new, it will return
	 * an empty collection; or if this Account has previously
	 * been saved, it will retrieve related TransfersRelatedByAccountDestinationId from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Account.
	 */
	public function getTransfersRelatedByAccountDestinationIdJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AccountPeer::DATABASE_NAME);
		}
		...
		if ($this->collTransfersRelatedByAccountDestinationId === null) {
			if ($this->isNew()) {
				...
				$this->collTransfersRelatedByAccountDestinationId = TransferPeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
		if ($deep) {
			if ($this->collTransfersRelatedByAccountOriginId) {
				foreach ((array) $this->collTransfersRelatedByAccountOriginId as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collTransfersRelatedByAccountDestinationId) {
				foreach ((array) $this->collTransfersRelatedByAccountDestinationId as $o) {
					$o->clearAllReferences($deep);
				}
			}
