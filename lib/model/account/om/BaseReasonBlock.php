...
/**
 * Base class that represents a row from the 'reason_block' table.
 *
 * 
 *
 ...
 */
abstract class BaseReasonBlock extends BaseObject  implements Persistent {
	 ...
	 * @return     ReasonBlock The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ReasonBlockPeer::ID;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = ReasonBlockPeer::DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = ReasonBlockPeer::NUM_COLUMNS - ReasonBlockPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ReasonBlock object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ReasonBlockPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseReasonBlock:delete:pre') as $callable)
			{
			...
			if ($ret) {
				ReasonBlockPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseReasonBlock:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseReasonBlock:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseReasonBlock:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				ReasonBlockPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ReasonBlockPeer::doInsert($this, $con);
					...
					$affectedRows += ReasonBlockPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ReasonBlockPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ReasonBlockPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ReasonBlockPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ReasonBlockPeer::ID)) $criteria->add(ReasonBlockPeer::ID, $this->id);
		if ($this->isColumnModified(ReasonBlockPeer::DESCRIPTION)) $criteria->add(ReasonBlockPeer::DESCRIPTION, $this->description);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ReasonBlockPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ReasonBlock (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ReasonBlock Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ReasonBlockPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ReasonBlockPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this ReasonBlock has previously been saved, it will retrieve
	 * related BalanceBlockedDetails from storage. If this ReasonBlock is new, it will return
		...
		if ($this->collBalanceBlockedDetails === null) {
			if ($this->isNew()) {
			   $this->collBalanceBlockedDetails = array();
				...
				$criteria->add(BalanceBlockedDetailPeer::REASON_BLOCK_ID, $this->id);
	 ...
	 * Otherwise if this ReasonBlock is new, it will return
	 * an empty collection; or if this ReasonBlock has previously
	 * been saved, it will retrieve related BalanceBlockedDetails from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in ReasonBlock.
	 */
	public function getBalanceBlockedDetailsJoinAccount($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ReasonBlockPeer::DATABASE_NAME);
		}
		...
		if ($this->collBalanceBlockedDetails === null) {
			if ($this->isNew()) {
				...
				$this->collBalanceBlockedDetails = BalanceBlockedDetailPeer::doSelectJoinAccount($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseReasonBlock:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseReasonBlock::%s', $method));
	  }
