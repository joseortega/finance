...
abstract class BaseProvincePeer {
	...
	const CLASS_DEFAULT = 'lib.model.location.Province';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CountryId', 'Name', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'countryId', 'name', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::COUNTRY_ID, self::NAME, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'country_id', 'name', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CountryId' => 1, 'Name' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'countryId' => 1, 'name' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::COUNTRY_ID => 1, self::NAME => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'country_id' => 1, 'name' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProvincePeer::COUNTRY_ID);
	...
	public static function doCountJoinCountry(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ProvincePeer::COUNTRY_ID, CountryPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Province objects pre-filled with their Country objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinCountry(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ProvincePeer::addSelectColumns($criteria);
		$startcol = (ProvincePeer::NUM_COLUMNS - ProvincePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Province) to $obj2 (Country)
	...
	/**
	 * Selects a collection of Province objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ProvincePeer::addSelectColumns($criteria);
		$startcol2 = (ProvincePeer::NUM_COLUMNS - ProvincePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Province) to the collection in $obj2 (Country)
				$obj2->addProvince($obj1);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProvincePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseProvincePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProvincePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseProvincePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProvincePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseProvincePeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(ProvincePeer::ID, $criteria->remove(ProvincePeer::ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProvincePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseProvincePeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$affectedRows += BasePeer::doDeleteAll(ProvincePeer::TABLE_NAME, $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += ProvincePeer::doOnDeleteCascade($criteria, $con);
