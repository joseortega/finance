...
abstract class BaseProvince extends BaseObject  implements Persistent {
	...
	public function setCountryId($v)
	{
		...
		if ($this->country_id !== $v) {
			$this->country_id = $v;
			$this->modifiedColumns[] = ProvincePeer::COUNTRY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->country_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 3; // 3 = ProvincePeer::NUM_COLUMNS - ProvincePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ProvincePeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ProvincePeer::doInsert($this, $con);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProvincePeer::COUNTRY_ID)) $criteria->add(ProvincePeer::COUNTRY_ID, $this->country_id);
	...
	public function getCountry(PropelPDO $con = null)
	{
		if ($this->aCountry === null && (($this->country_id !== "" && $this->country_id !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCountry->addProvinces($this);
			 */
		}
	 ...
	 * Otherwise if this Province has previously been saved, it will retrieve
	 * related Citys from storage. If this Province is new, it will return
		...
		if ($this->collCitys === null) {
			if ($this->isNew()) {
			   $this->collCitys = array();
				...
				$criteria->add(CityPeer::PROVINCE_ID, $this->id);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseProvince:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseProvince::%s', $method));
	  }
