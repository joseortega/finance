...
abstract class BaseCountryPeer {
	...
	const CLASS_DEFAULT = 'lib.model.location.Country';
	...
	{
		// invalidate objects in ProvincePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Province objects
			$criteria = new Criteria(ProvincePeer::DATABASE_NAME);
			
			$criteria->add(ProvincePeer::COUNTRY_ID, $obj->getId());
			$affectedRows += ProvincePeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
