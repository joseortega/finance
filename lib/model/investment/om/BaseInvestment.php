...
abstract class BaseInvestment extends BaseObject  implements Persistent {
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($this->isModified() && !$this->isColumnModified(InvestmentPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(InvestmentPeer::CREATED_AT))
				{
	 ...
	 * related Transactions from storage. If this Investment is new, it will return
		...
		if ($this->collTransactions === null) {
			if ($this->isNew()) {
			   $this->collTransactions = array();
				...
				$criteria->add(TransactionPeer::INVESTMENT_ID, $this->id);
