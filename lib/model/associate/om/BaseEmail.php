...
abstract class BaseEmail extends BaseObject  implements Persistent {
	...
	public function setAssociateId($v)
	{
		...
		if ($this->associate_id !== $v) {
			$this->associate_id = $v;
			$this->modifiedColumns[] = EmailPeer::ASSOCIATE_ID;
		}
	...
	public function setAddress($v)
	{
		...
		if ($this->address !== $v) {
			$this->address = $v;
			$this->modifiedColumns[] = EmailPeer::ADDRESS;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EmailPeer::ASSOCIATE_ID)) $criteria->add(EmailPeer::ASSOCIATE_ID, $this->associate_id);
		if ($this->isColumnModified(EmailPeer::ADDRESS)) $criteria->add(EmailPeer::ADDRESS, $this->address);
	...
	public function getAssociate(PropelPDO $con = null)
	{
		if ($this->aAssociate === null && (($this->associate_id !== "" && $this->associate_id !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aAssociate->addEmails($this);
			 */
		}
