...
abstract class BasePhone extends BaseObject  implements Persistent {
	...
	public function setAssociateId($v)
	{
		...
		if ($this->associate_id !== $v) {
			$this->associate_id = $v;
			$this->modifiedColumns[] = PhonePeer::ASSOCIATE_ID;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = PhonePeer::TYPE;
		}
	...
	public function setNumber($v)
	{
		...
		if ($this->number !== $v) {
			$this->number = $v;
			$this->modifiedColumns[] = PhonePeer::NUMBER;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = PhonePeer::NUM_COLUMNS - PhonePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BasePhone:delete:pre') as $callable)
			{
			...
			if ($ret) {
				PhonePeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePhone:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BasePhone:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePhone:save:post') as $callable)
				{
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PhonePeer::doInsert($this, $con);
					...
					$affectedRows += PhonePeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PhonePeer::ASSOCIATE_ID)) $criteria->add(PhonePeer::ASSOCIATE_ID, $this->associate_id);
		if ($this->isColumnModified(PhonePeer::TYPE)) $criteria->add(PhonePeer::TYPE, $this->type);
		if ($this->isColumnModified(PhonePeer::NUMBER)) $criteria->add(PhonePeer::NUMBER, $this->number);
	...
	public function getAssociate(PropelPDO $con = null)
	{
		if ($this->aAssociate === null && (($this->associate_id !== "" && $this->associate_id !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aAssociate->addPhones($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BasePhone:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BasePhone::%s', $method));
	  }
