...
abstract class BaseEmailPeer {
	...
	const CLASS_DEFAULT = 'lib.model.associate.Email';
	...
	const ASSOCIATE_ID = 'email.ASSOCIATE_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'AssociateId', 'Address', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'associateId', 'address', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ASSOCIATE_ID, self::ADDRESS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'associate_id', 'address', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AssociateId' => 1, 'Address' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'associateId' => 1, 'address' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ASSOCIATE_ID => 1, self::ADDRESS => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'associate_id' => 1, 'address' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(EmailPeer::ASSOCIATE_ID);
		$criteria->addSelectColumn(EmailPeer::ADDRESS);
	}
	...
	public static function doCountJoinAssociate(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EmailPeer::ASSOCIATE_ID, AssociatePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Email objects pre-filled with their Associate objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAssociate(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Email) to $obj2 (Associate)
				$obj2->addEmail($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Email) to the collection in $obj2 (Associate)
				$obj2->addEmail($obj1);
