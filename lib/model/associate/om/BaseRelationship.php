...
abstract class BaseRelationship extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = RelationshipPeer::ID;
		}
	...
	public function setAssociateId($v)
	{
		...
		if ($this->associate_id !== $v) {
			$this->associate_id = $v;
			$this->modifiedColumns[] = RelationshipPeer::ASSOCIATE_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = RelationshipPeer::NAME;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = RelationshipPeer::TYPE;
		}
	...
	public function setPhoneNumber($v)
	{
		...
		if ($this->phone_number !== $v) {
			$this->phone_number = $v;
			$this->modifiedColumns[] = RelationshipPeer::PHONE_NUMBER;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->phone_number = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = RelationshipPeer::NUM_COLUMNS - RelationshipPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseRelationship:delete:pre') as $callable)
			{
			...
			if ($ret) {
				RelationshipPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseRelationship:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseRelationship:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseRelationship:save:post') as $callable)
				{
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RelationshipPeer::doInsert($this, $con);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setPhoneNumber($arr[$keys[4]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RelationshipPeer::ID)) $criteria->add(RelationshipPeer::ID, $this->id);
		if ($this->isColumnModified(RelationshipPeer::ASSOCIATE_ID)) $criteria->add(RelationshipPeer::ASSOCIATE_ID, $this->associate_id);
		if ($this->isColumnModified(RelationshipPeer::NAME)) $criteria->add(RelationshipPeer::NAME, $this->name);
		if ($this->isColumnModified(RelationshipPeer::TYPE)) $criteria->add(RelationshipPeer::TYPE, $this->type);
		if ($this->isColumnModified(RelationshipPeer::PHONE_NUMBER)) $criteria->add(RelationshipPeer::PHONE_NUMBER, $this->phone_number);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RelationshipPeer::ID, $this->id);
	...
	public function getAssociate(PropelPDO $con = null)
	{
		if ($this->aAssociate === null && (($this->associate_id !== "" && $this->associate_id !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aAssociate->addRelationships($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseRelationship:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseRelationship::%s', $method));
	  }
